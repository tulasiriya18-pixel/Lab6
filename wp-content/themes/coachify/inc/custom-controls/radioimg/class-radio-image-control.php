<?php
/**
 * Coachify Customizer Radio Image Control.
 * 
 * @package Coachify
*/
...
if( ! class_exists( 'Coachify_Radio_Image_Control' ) ){
	/**
	 * Radio Image control (modified radio).
    */
	class Coachify_Radio_Image_Control extends WP_Customize_Control {

		public $type    = 'coachify-radio-image';
		public $tooltip = '';
		public $col     = 'col-2';
		public $svg     = false;
		public $group;
        ...
        public function enqueue() {            
            wp_enqueue_style( 'coachify-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.css', null );
            wp_enqueue_script( 'coachify-radio-image', get_template_directory_uri() . '/inc/custom-controls/radioimg/radio-image.js', array( 'jquery' ), false, true ); //for radio-image                
        }
