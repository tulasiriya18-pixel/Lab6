<?php
/**
 * Coachify Appearance Settings
 *
 * @package Coachify
 */
if ( ! function_exists( 'coachify_customize_register_typography' ) ) : 

function coachify_customize_register_typography( $wp_customize ) {
    $defaults      = coachify_get_typography_defaults();
    $fontsdefaults = coachify_get_general_defaults();
    
    /** Typography */
    $wp_customize->add_section(
        'typography_settings',
        array(
            'title'    => __( 'Typography', 'coachify' ),
            'priority' => 10
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[family]',
        array(
            'default'           => $defaults['accent_font']['family'],
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[variants]',
        array(
            'default'           => $defaults['accent_font']['variants'],
            'sanitize_callback' => 'coachify_sanitize_variants',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[category]',
        array(
            'default'           => $defaults['accent_font']['category'],
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[weight]',
        array(
            'default'           => $defaults['accent_font']['weight'],
            'sanitize_callback' => 'sanitize_key',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[transform]',
        array(
            'default'           => $defaults['accent_font']['transform'],
            'sanitize_callback' => 'sanitize_key',
            'transport'         => 'postMessage',
    ...
    $wp_customize->add_control(
        new Coachify_Typography_Customize_Control(
            $wp_customize,
            'accent_font_typography',
            array(
                'section'  => 'typography_settings',
                'settings' => array(
                    'family'    => 'accent_font[family]',
                    'variant'   => 'accent_font[variants]',
                    'category'  => 'accent_font[category]',
                ),
                'group'    => 'accent_font_group',
            )
        )
    );
    ...
    /** Primary Font Size */
    $wp_customize->add_setting(
        'accent_font[desktop][font_size]',
        array(
            'default'           => $defaults['accent_font']['desktop']['font_size'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[tablet][font_size]',
        array(
            'default'           => $defaults['accent_font']['tablet']['font_size'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[mobile][font_size]',
        array(
            'default'           => $defaults['accent_font']['mobile']['font_size'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_control(
        new Coachify_Range_Slider_Control(
            $wp_customize,
            'accent_font[font_size]',
            array(
                'label'    => __( 'Size', 'coachify' ),
                'section'  => 'typography_settings',
                'settings' => array(
                    'desktop' => 'accent_font[desktop][font_size]',
                    'tablet'  => 'accent_font[tablet][font_size]',
                    'mobile'  => 'accent_font[mobile][font_size]',
                ),
                'choices' => array(
                    'desktop' => array(
                        'min'  => 1,
    ...
    /** Primary Font Line Height */
    $wp_customize->add_setting(
        'accent_font[desktop][line_height]',
        array(
            'default'           => $defaults['accent_font']['desktop']['line_height'],
            'sanitize_callback' => 'coachify_sanitize_empty_floatval',
            'transport'         => 'postMessage',
        )
    );
    $wp_customize->add_setting(
        'accent_font[tablet][line_height]',
        array(
            'default'           => $defaults['accent_font']['tablet']['line_height'],
            'sanitize_callback' => 'coachify_sanitize_empty_floatval',
            'transport'         => 'postMessage',
        )
    );
    $wp_customize->add_setting(
        'accent_font[mobile][line_height]',
        array(
            'default'           => $defaults['accent_font']['mobile']['line_height'],
            'sanitize_callback' => 'coachify_sanitize_empty_floatval',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_control(
        new Coachify_Range_Slider_Control(
            $wp_customize,
            'accent_font[line_height]',
            array(
                'label'    => __( 'Line Height', 'coachify' ),
                'section'  => 'typography_settings',
                'settings' => array(
                    'desktop' => 'accent_font[desktop][line_height]',
                    'tablet' => 'accent_font[tablet][line_height]',
                    'mobile' => 'accent_font[mobile][line_height]',
                ),
                'group'    => 'accent_font_group',
                'choices' => array(
                    'desktop' => array(
    ...
    /** Primary Font Letter Spacing */
    $wp_customize->add_setting(
        'accent_font[desktop][letter_spacing]',
        array(
            'default'           => $defaults['accent_font']['desktop']['letter_spacing'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[tablet][letter_spacing]',
        array(
            'default'           => $defaults['accent_font']['tablet']['letter_spacing'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_setting(
        'accent_font[mobile][letter_spacing]',
        array(
            'default'           => $defaults['accent_font']['mobile']['letter_spacing'],
            'sanitize_callback' => 'coachify_sanitize_empty_absint',
            'transport'         => 'postMessage',
        )
    );
    ...
    $wp_customize->add_control(
        new Coachify_Range_Slider_Control(
            $wp_customize,
            'accent_font[letter_spacing]',
            array(
                'label'    => __( 'Letter Spacing', 'coachify' ),
                'section'  => 'typography_settings',
                'settings' => array(
                    'desktop' => 'accent_font[desktop][letter_spacing]',
                    'tablet'  => 'accent_font[tablet][letter_spacing]',
                    'mobile'  => 'accent_font[mobile][letter_spacing]',
                ),
                'group'    => 'accent_font_group',
                'choices' => array(
                    'desktop' => array(
    ...
    $wp_customize->add_control(
        new Coachify_Typography_Customize_Control(
            $wp_customize,
            'accent_font_typography_weight',
            array(
                'section'  => 'typography_settings',
                'settings' => array(
                    'weight'    => 'accent_font[weight]',
                ),
                'group'    => 'accent_font_group',
            )
        )
    ...
    $wp_customize->add_control(
        new Coachify_Typography_Customize_Control(
            $wp_customize,
            'accent_font_typography_transform',
            array(
                'section'  => 'typography_settings',
                'settings' => array(
                    'transform' => 'accent_font[transform]',
                ),
                'group'    => 'accent_font_group',
            )
        )
    ...
    $wp_customize->add_control(
        new Coachify_Toggle_Control( 
            ...
            array(
                'section'     => 'typography_settings',
                'label'       => __( 'Load Google Fonts Locally', 'coachify' ),
                'description' => __( 'This will load Google fonts from your server to speed up your site and make it GDPR compliant.', 'coachify' ),
                'priority' => 20
            )
        )
    );
    ...
    $wp_customize->add_control(
        new Coachify_Toggle_Control( 
            ...
            array(
                'section'         => 'typography_settings',
                'label'           => __( 'Preload Local Fonts', 'coachify' ),
                'description'     => __( 'Preloading Google fonts will speed up your website speed.', 'coachify' ),
                'active_callback' => 'coachify_performance_fonts',
                'priority' => 20
            )
        )
    );
    ...
    $wp_customize->add_control(
        'flush_google_fonts',
        array(
            'label'       => __( 'Flush Local Fonts Cache', 'coachify' ),
            'description' => __( 'Click the button to reset the local fonts cache.', 'coachify' ),
            'type'        => 'button',
            'settings'    => array(),
            'section'     => 'typography_settings',
            'input_attrs' => array(
                'value' => __( 'Flush Local Fonts Cache', 'coachify' ),
...
add_action( 'customize_register', 'coachify_customize_register_typography' );